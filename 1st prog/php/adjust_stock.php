...
if (empty($product_id) || $adjustment_quantity <= 0) {
...
if ($updateStmt->execute()) {
    ...
    header("Location: product_management.php?message=Product stock $action successfully");
} else {
    header("Location: product_management.php?error=Failed to adjust stock");
}
